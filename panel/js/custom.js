jQuery.extend(DateInput.DEFAULT_OPTS, {
  month_names: ["Ocak", "Şubat", "Mart", "Nisan", "Mayýs", "Haziran", "Temmuz", "Aðustos", "Eylül", "Ekim", "Kasım", "Aralık"],
  short_month_names: ["Oca", "Þub", "Mar", "Nis", "May", "Haz", "Tem", "Aðu", "Eyl", "Ekim", "Kas", "Ara"],
  short_day_names: ["Pzr", "Pzt", "Sal", "Çrþ", "Prþ", "Cum", "Cmt"]
});
$(function () {
	...
	$('ul.imglist .delete a').click(function() {
		if (confirm("Fotoðrafý silmek istediðinize emin misiniz?")) {
