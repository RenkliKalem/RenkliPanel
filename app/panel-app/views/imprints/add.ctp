...
<div class="block">
				<div class="block_head">
					...
					<h2>YENİ BAYİ BİLGİSİ OLUŞTUR</h2>
...
<?php echo $this->Form->create('Imprintgroup',Array('encoding' => Null,'url' => array('controller' => 'imprints', 'action' => 'add'),'inputDefaults' => Array('div' => false,'format' => array('before', 'label', 'error', 'between', 'input', 'after'))));?>
<p>
...
<p>
	<?php echo $this->Form->input('name',Array('label'=>Array('text' =>'Bayi Bilgisi :','class' => 'req'),'class' => 'text medium big','autocomplete' => 'off','between' => '<br/>','error' => array('wrap' => 'span','class' => 'note error')));?>
</p>
