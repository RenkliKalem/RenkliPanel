...
<?php echo $this->Form->input('id',Array('label'=>Array('text' =>' Aktif'),'type' => 'hidden','class' => 'checkbox','format' => array('before', 'input', 'label', 'error', 'between', 'after'),'error' => array('wrap' => 'span','class' => 'note error')));?>
		<p><?php echo $this->Form->input('maps',Array('label'=>Array('text' =>'Google Maps Koordinatları :','class' => 'req'),'class' => 'text medium','autocomplete' => 'off','between' => '<br/>','error' => array('wrap' => 'span','class' => 'note error')));?></p>
		<p><?php echo $this->Form->input('name',Array('label'=>Array('text' =>'Adres Başlığı :','class' => 'req'),'class' => 'text medium big','autocomplete' => 'off','between' => '<br/>','error' => array('wrap' => 'span','class' => 'note error')));?></p>
<div id="datas">
