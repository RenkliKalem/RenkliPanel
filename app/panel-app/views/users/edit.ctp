<div class="block">			
				<div class="block_head">
					...
					<ul>
						<li><?=$this->Html->link('KULLANICILARA gerİ dÖn',Array('controller' => 'users','action' => 'index','page' => $page))?></li>
					</ul>
				</div>	
                ...
                <?php echo $this->Session->flash(); ?>
					...
					<?php echo $this->Form->input('id',Array('label'=>Array('text' =>'Haber Kategorisi :','class' => 'req'),'class' => 'styled','autocomplete' => 'off','between' => '<br/>','error' => array('wrap' => 'span','class' => 'note error')));?>
                        ...
                        <p><?php echo $this->Form->input('User.password',Array('label'=>Array('text' =>'Şifre (Boş Bırakırsanız Değişmez) :','class' => 'req'),'class' => 'text','autocomplete' => 'off','between' => '<br/>','error' => array('wrap' => 'span','class' => 'note error')));?></p>
