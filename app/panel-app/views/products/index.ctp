			<div class="block"> 
				...
				<table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('Adı','name_tr');?></th>
                            <th>&nbsp;</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?=$Product['Productgroup']['name_tr'];?>&nbsp;</td>
                        <td><?php echo substr($Product['Product']['name_tr'],0,50) . '...'; ?>&nbsp;</td>
                        <td class="delete"><?php echo $this->Html->link(__('Fotoğraf(' . count($Product['Image']) . ')', true),  array('controller'=> 'images','action' => 'index','product',$Product['Product']['id'])); ?> |
                        	<?php echo $this->Html->link(__('Döküman(' . count($Product['Document']) . ')', true),  array('controller'=> 'documents','action' => 'index','product',$Product['Product']['id'])); ?> | 
