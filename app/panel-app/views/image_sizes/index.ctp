			<div class="block"> 
				...
				<div class="block_head"> 
                    ...
                    <ul> 
						<li><?=$this->Html->link('Resİm tİplerİ',Array('controller' => 'image_types','action' => 'index'))?></li> 
						<li><?=$this->Html->link('Resİm boyutu ekle',Array('controller' => 'image_sizes','action' => 'add'))?></li> 
					</ul>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('Dosya Adı','filename');?></th>
                            <th><?php echo $this->Paginator->sort('Genişlik','width');?></th>
                            <th><?php echo $this->Paginator->sort('Yükseklik','height');?></th>
                            <th><?php echo $this->Paginator->sort('Kalite','quality');?></th>
                            <th><?php echo $this->Paginator->sort('Resim Tipi','image_type_id');?></th>
                            <th class="actions">&nbsp;</th>
                    </tr>
