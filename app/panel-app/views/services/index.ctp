			<div class="block"> 
				...
				<table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('Hizmet Adı','name_tr');?></th>
                            <th>&nbsp;</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo substr($service['Service']['name_tr'],0,50) . '...'; ?>&nbsp;</td>
                        <td class="delete"><?php echo $this->Html->link(__('Fotoğraf(' . count($service['Image']) . ')', true),  array('controller'=> 'images','action' => 'index','service',$service['Service']['id'])); ?> | <?php echo $this->Html->link(__('Düzenle', true), array('action' => 'edit', $service['Service']['id'])); ?> |
