...
<p><?php echo $this->Form->input('has_confirm',Array('label'=>Array('text' =>'Menüde Gözüksün','class' => 'req'),'class' => 'checkbox','autocomplete' => 'off','between' => ' ','checked' => True,'error' => array('wrap' => 'span','class' => 'note error')));?></p>
<p><?php echo $this->Form->input('has_confirm',Array('label'=>Array('text' =>'Alt Sayfada Gözüksün','class' => 'req'),'class' => 'checkbox','autocomplete' => 'off','between' => ' ','checked' => True,'error' => array('wrap' => 'span','class' => 'note error')));?></p>
<p>
