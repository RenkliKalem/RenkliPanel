...
<p>
	<?php echo $this->Form->input('date',Array('label'=>Array('text' =>'Etkinlik Tarihi :'),'class' => 'text date_picker','value' => str_replace('Mayıs','May',$this->Genel->tarih('gun kisaay yil',date('Y-m-d'))),'type' => 'text','autocomplete' => 'off','between' => '<br/>','error' => array('wrap' => 'span','class' => 'note error')));?>
</p>                                    
<p>
